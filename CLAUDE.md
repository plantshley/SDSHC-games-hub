...
- The team/school dropdown on game intros sources from the event roster regardless of per-event approval, so newly-added teams can play immediately; their scores just don't appear publicly until approved.
