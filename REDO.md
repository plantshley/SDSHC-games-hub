...
* `Please open browser to view and click trhough the websites/presentations I’ve linked for design inspiration and game features/functionality. Get screenshots when necessary/helpful. If you need css or code chunks let me know.`   
* `Use colors and general cute pixel farming theme like https://cupnooble.itch.io/sprout-lands-asset-pack`   
* `Smooth transitions and animations just like this canva presention: https://www.canva.com/design/DAGW0LcxO4Y/-UEv3eg5eGZnPGX6o1WHbA/view?embed#1`  
* `Other pixel-themed gamed websites to reference:`   
...
* `This should not be ugly like a static html file is limited to, I just need offline support througha local host running via npm run dev. I dont need it to be a static file if that will limit beautiful, smooth visuals which I value more.`   
...
`Base mechanic: Pick a color from a palette, then tap regions of a line-art illustration to flood-fill them. Uses canvas-based flood-fill on SVG images extracted from the Pre-K PDF coloring pages.`
...
`7 coloring pages. Simple, relaxing activity for youngest kids.`
...
`Basic mechanic: grag words to correct image + description (or correct spot on the image, in the case of levels 2 and 3); image fills in with color when correct`
...
* `Level selection screen:`   
  ...
  * `Character standing on Hills_topsoil_H repeat across the bottom of the screen, various biom things ushes, trrees,flowers-gif pixel_farm_scene3 background`  
